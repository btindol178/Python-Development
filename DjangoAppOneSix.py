...
# then runserver to check admin!!! dont do this every time
#python manage.py runserver
# add/admin and check out webpages!!!!!!

# step 32 go to views and put this
from appseven.models import Topic,Webpage,AccessRecord

def index(request):
    webpages_list = AccessRecord.objects.order_by('date')
    date_dict = {'access_records':webpages_list}
    #my_dict = {'insert_me':"Hello I am from views.py!"}
    return render(request,'appseven/index.html',context = date_dict)
    #return render(request,'appseven/index.html',context = my_dict)

# step 33 go over to html page and put clear and put this into html body
<!DOCTYPE html>
{% load static %}
...
# step 34 edit css file to make it look better!
# in mystyle.css add this on

.djangotwo{
    border: 2px solid black
}

# step 35 add urls into app seven. and fill will this
from appseven import views
...
# step 36 in urls for ProSeven add this
