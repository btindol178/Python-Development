...
# Change directory cd/ProTwo to get into file directory
...
# Step 7
# In first application file Or first project file and put AppTwo in the settings then run server to make sure
#'AppTwo' # we created this app and we need to install it in our settings
